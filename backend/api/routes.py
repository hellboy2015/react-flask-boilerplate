...
app.config['MAIL_USERNAME'] = 'julioexp89@gmail.com'
app.config['MAIL_PASSWORD'] = 'afr:]`y1X*nJ'
...
def UsuarioNuevo():
    ...
    if user is not None:
        ...
        msg = Message('Busc@PYME aviso', sender = 'julioexp89@gmail.com', recipients = ['julioexp89@gmail.com',email])
...
def AdminNuevo():
    ...
    with urlopen('https://makemeapassword.ligos.net/api/v1/alphanumeric/json?c=1&l=12') as r:
        ...
        msg = Message('Busc@PYME aviso', sender = 'julioexp89@gmail.com', recipients = ['julioexp89@gmail.com'])
